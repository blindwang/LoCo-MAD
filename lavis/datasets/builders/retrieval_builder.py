...
from lavis.datasets.datasets.retrieval_datasets import (
    ...
    VALVideoRetrievalEvalDataset,
    VALVideoRetrievalDataset
)
...
@registry.register_builder("val_msrvtt_retrieval")
class VALMSRVTTRetrievalBuilder(BaseDatasetBuilder):
    train_dataset_cls = VALVideoRetrievalDataset
    eval_dataset_cls = VALVideoRetrievalEvalDataset

    DATASET_CONFIG_DICT = {"default": "configs/datasets/msrvtt/defaults_val_ret.yaml"}
...
@registry.register_builder("val_didemo_retrieval")
class VALMSRVTTRetrievalBuilder(BaseDatasetBuilder):
    train_dataset_cls = VALVideoRetrievalDataset
    eval_dataset_cls = VALVideoRetrievalEvalDataset

    DATASET_CONFIG_DICT = {"default": "configs/datasets/didemo/defaults_val_ret.yaml"}

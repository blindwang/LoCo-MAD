...
from lavis.datasets.datasets.video_vqa_datasets import VideoQADataset, VideoQAFeatureDataset
...
@registry.register_builder("msrvtt_val_qa")
class MSRVTTFeatQABuilder(BaseDatasetBuilder):
    train_dataset_cls = VideoQAFeatureDataset
    eval_dataset_cls = VideoQAFeatureDataset
    DATASET_CONFIG_DICT = {
        "default": "configs/datasets/msrvtt/defaults_val_qa.yaml",
    }
